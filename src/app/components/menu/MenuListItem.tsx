...
export default function MenuListItem({
  ...
  const [showNoImage, setShowNoImage] = useState(!plato.imagen);
  const imageSrc = plato.imagen || '';

  return (
    <div className="flex items-center bg-white rounded-lg shadow p-3 z-0">
      <div className="relative w-20 h-20 flex-shrink-0 rounded overflow-hidden bg-gray-100 flex items-center justify-center">
        {!showNoImage && imageSrc ? (
          <>
            <Image
              src={imageSrc}
              alt={plato.nombre}
